...
export function ProjectsHeader({ viewMode, onViewModeChange, onAddGoal }: ProjectsHeaderProps) {
  return (
    <div className="flex items-center justify-between">
      <div>
        <h1 className="text-3xl font-display font-bold tracking-tight mb-1">Proyectos y metas</h1>
        <p className="text-muted-foreground text-sm">Da seguimiento a tus metas de ahorro por moneda</p>
      </div>
